...
// AddrOfObjectList is a helper type constraint for accepting a struct value that
// implements the ObjectList interface.
...
// Create is a generic equivalent of [Ctl.Create].
...
// Delete is a generic equivalent of [Ctl.Delete].
...
// AsKey converts an [Object] into an [ObjectKey].
