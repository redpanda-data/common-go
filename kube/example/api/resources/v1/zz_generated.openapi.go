...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/redpanda-data/common-go/kube/example/api/resources/v1.ClusterRef":    schema_example_api_resources_v1_ClusterRef(ref),
		"github.com/redpanda-data/common-go/kube/example/api/resources/v1.Virtual":       schema_example_api_resources_v1_Virtual(ref),
		"github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualList":   schema_example_api_resources_v1_VirtualList(ref),
		"github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualSpec":   schema_example_api_resources_v1_VirtualSpec(ref),
		"github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualStatus": schema_example_api_resources_v1_VirtualStatus(ref),
...
func schema_example_api_resources_v1_ClusterRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterRef is a reference to the cluster where this resource should be created.",
				Type:        []string{"object"},
...
func schema_example_api_resources_v1_Virtual(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Virtual is a virtual CRD",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualSpec", "github.com/redpanda-data/common-go/kube/example/api/resources/v1.VirtualStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_example_api_resources_v1_VirtualList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualList is a list of Virtual objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/redpanda-data/common-go/kube/example/api/resources/v1.Virtual"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/redpanda-data/common-go/kube/example/api/resources/v1.Virtual", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_example_api_resources_v1_VirtualSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualSpec defines the desired state of a virtual.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"clusterRef": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/redpanda-data/common-go/kube/example/api/resources/v1.ClusterRef"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/redpanda-data/common-go/kube/example/api/resources/v1.ClusterRef"},
	}
}

func schema_example_api_resources_v1_VirtualStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualStatus is the status for a virtual.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"linked": {
						SchemaProps: spec.SchemaProps{
