...
// @generated from file redpanda/otel/v1/metric.proto (package redpanda.otel.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum redpanda.otel.v1.AggregationTemporality
 */
...
proto3.util.setEnumType(AggregationTemporality, "redpanda.otel.v1.AggregationTemporality", [
 ...
 *
 *
 * @generated from enum redpanda.otel.v1.DataPointFlags
 */
...
proto3.util.setEnumType(DataPointFlags, "redpanda.otel.v1.DataPointFlags", [
 ...
 * strongly encouraged.
 *
 * @generated from message redpanda.otel.v1.Metric
 */
export class Metric extends Message<Metric> {
   ...
   *
   * @generated from oneof redpanda.otel.v1.Metric.data
   */
  data: {
    /**
     * @generated from field: redpanda.otel.v1.Gauge gauge = 8;
     */
    value: Gauge;
    case: "gauge";
  } | {
    /**
     * @generated from field: redpanda.otel.v1.Sum sum = 9;
     */
    value: Sum;
    case: "sum";
  } | {
    /**
     * @generated from field: redpanda.otel.v1.Histogram histogram = 10;
     */
    value: Histogram;
    case: "histogram";
  } | {
    /**
     * @generated from field: redpanda.otel.v1.ExponentialHistogram exponential_histogram = 11;
     */
    value: ExponentialHistogram;
    case: "exponentialHistogram";
  } | {
    /**
     * @generated from field: redpanda.otel.v1.Summary summary = 12;
     */
    value: Summary;
    case: "summary";
   ...
   * unpredictable.
   *
   * @generated from field: repeated redpanda.otel.v1.KeyValue metadata = 13;
   */
  metadata: KeyValue[] = [];
  ...
  static readonly typeName = "redpanda.otel.v1.Metric";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 8, name: "gauge", kind: "message", T: Gauge, oneof: "data" },
    { no: 9, name: "sum", kind: "message", T: Sum, oneof: "data" },
    { no: 10, name: "histogram", kind: "message", T: Histogram, oneof: "data" },
    { no: 11, name: "exponential_histogram", kind: "message", T: ExponentialHistogram, oneof: "data" },
    { no: 12, name: "summary", kind: "message", T: Summary, oneof: "data" },
    { no: 13, name: "metadata", kind: "message", T: KeyValue, repeated: true },
  ]);
 ...
 *
 * @generated from message redpanda.otel.v1.Gauge
 */
export class Gauge extends Message<Gauge> {
   ...
   * attributes).
   *
   * @generated from field: repeated redpanda.otel.v1.NumberDataPoint data_points = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.Gauge";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message redpanda.otel.v1.Sum
 */
export class Sum extends Message<Sum> {
   ...
   *
   * @generated from field: redpanda.otel.v1.AggregationTemporality aggregation_temporality = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.Sum";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "data_points", kind: "message", T: NumberDataPoint, repeated: true },
 ...
 *
 * @generated from message redpanda.otel.v1.Histogram
 */
export class Histogram extends Message<Histogram> {
   ...
   * attributes).
   *
   * @generated from field: repeated redpanda.otel.v1.HistogramDataPoint data_points = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.Histogram";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message redpanda.otel.v1.ExponentialHistogram
 */
export class ExponentialHistogram extends Message<ExponentialHistogram> {
   ...
   * attributes).
   *
   * @generated from field: repeated redpanda.otel.v1.ExponentialHistogramDataPoint data_points = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.ExponentialHistogram";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * cumulative values.
 *
 * @generated from message redpanda.otel.v1.Summary
 */
export class Summary extends Message<Summary> {
   ...
   * attributes).
   *
   * @generated from field: repeated redpanda.otel.v1.SummaryDataPoint data_points = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.Summary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message redpanda.otel.v1.NumberDataPoint
 */
export class NumberDataPoint extends Message<NumberDataPoint> {
   ...
   * unpredictable.
   *
   * @generated from field: repeated redpanda.otel.v1.KeyValue attributes = 7;
   */
  attributes: KeyValue[] = [];
   ...
   *
   * @generated from oneof redpanda.otel.v1.NumberDataPoint.value
   */
  value: {
    /**
   ...
   *
   * @generated from field: repeated redpanda.otel.v1.Exemplar exemplars = 5;
   */
  exemplars: Exemplar[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.NumberDataPoint";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * "sum" are known.
 *
 * @generated from message redpanda.otel.v1.HistogramDataPoint
 */
export class HistogramDataPoint extends Message<HistogramDataPoint> {
   ...
   * unpredictable.
   *
   * @generated from field: repeated redpanda.otel.v1.KeyValue attributes = 9;
   */
  attributes: KeyValue[] = [];
   ...
   * measurements that were used to form the data point
   *
   * @generated from field: repeated redpanda.otel.v1.Exemplar exemplars = 8;
   */
  exemplars: Exemplar[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.HistogramDataPoint";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 *
 * @generated from message redpanda.otel.v1.ExponentialHistogramDataPoint
 */
export class ExponentialHistogramDataPoint extends Message<ExponentialHistogramDataPoint> {
   ...
   *
   * @generated from field: redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets positive = 8;
   */
   ...
   *
   * @generated from field: redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets negative = 9;
   */
   ...
   * measurements that were used to form the data point
   *
   * @generated from field: repeated redpanda.otel.v1.Exemplar exemplars = 11;
   */
  exemplars: Exemplar[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.ExponentialHistogramDataPoint";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * of counts.
 *
 * @generated from message redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets
 */
export class ExponentialHistogramDataPoint_Buckets extends Message<ExponentialHistogramDataPoint_Buckets> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * cumulative values.
 *
 * @generated from message redpanda.otel.v1.SummaryDataPoint
 */
export class SummaryDataPoint extends Message<SummaryDataPoint> {
   ...
   * increasing.
   *
   * @generated from field: repeated redpanda.otel.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.SummaryDataPoint";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 7, name: "attributes", kind: "message", T: KeyValue, repeated: true },
    { no: 2, name: "start_time_unix_nano", kind: "scalar", T: 6 /* ScalarType.FIXED64 */ },
    { no: 3, name: "time_unix_nano", kind: "scalar", T: 6 /* ScalarType.FIXED64 */ },
 ...
 *
 * @generated from message redpanda.otel.v1.SummaryDataPoint.ValueAtQuantile
 */
export class SummaryDataPoint_ValueAtQuantile extends Message<SummaryDataPoint_ValueAtQuantile> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.SummaryDataPoint.ValueAtQuantile";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message redpanda.otel.v1.Exemplar
 */
export class Exemplar extends Message<Exemplar> {
   ...
   *
   * @generated from field: repeated redpanda.otel.v1.KeyValue filtered_attributes = 7;
   */
   ...
   * inside this oneof.
   *
   * @generated from oneof redpanda.otel.v1.Exemplar.value
   */
  value: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.otel.v1.Exemplar";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
