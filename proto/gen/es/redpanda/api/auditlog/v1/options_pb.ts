...
proto3.util.setEnumType(AuditPolicy, "redpanda.api.auditlog.v1.AuditPolicy", [
...
export class ServiceAuditConfig extends Message<ServiceAuditConfig> {
  ...
  static readonly typeName = "redpanda.api.auditlog.v1.ServiceAuditConfig";
...
export class MethodAuditConfig extends Message<MethodAuditConfig> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.auditlog.v1.MethodAuditConfig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
