...
func (AggregationTemporality) Descriptor() protoreflect.EnumDescriptor {
	return file_redpanda_otel_v1_metric_proto_enumTypes[0].Descriptor()
}

func (AggregationTemporality) Type() protoreflect.EnumType {
	return &file_redpanda_otel_v1_metric_proto_enumTypes[0]
}
...
func (AggregationTemporality) EnumDescriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{0}
}
...
//
//	(point.flags & DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK) ==
...
func (DataPointFlags) Descriptor() protoreflect.EnumDescriptor {
	return file_redpanda_otel_v1_metric_proto_enumTypes[1].Descriptor()
}

func (DataPointFlags) Type() protoreflect.EnumType {
	return &file_redpanda_otel_v1_metric_proto_enumTypes[1]
}
...
func (DataPointFlags) EnumDescriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{1}
}
...
type Metric struct {
	...
	// unpredictable.
	Metadata      []*KeyValue `protobuf:"bytes,13,rep,name=metadata,proto3" json:"metadata,omitempty"`
...
func (x *Metric) Reset() {
	*x = Metric{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[0]
...
func (x *Metric) GetScope() *InstrumentationScope {
	if x != nil {
		return x.Scope
	}
	return nil
...
type Metric_Gauge struct {
	Gauge *Gauge `protobuf:"bytes,8,opt,name=gauge,proto3,oneof"`
}

type Metric_Sum struct {
	Sum *Sum `protobuf:"bytes,9,opt,name=sum,proto3,oneof"`
}

type Metric_Histogram struct {
	Histogram *Histogram `protobuf:"bytes,10,opt,name=histogram,proto3,oneof"`
}

type Metric_ExponentialHistogram struct {
	ExponentialHistogram *ExponentialHistogram `protobuf:"bytes,11,opt,name=exponential_histogram,json=exponentialHistogram,proto3,oneof"`
}
...
func (x *Gauge) Reset() {
	*x = Gauge{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type Sum struct {
	...
	AggregationTemporality AggregationTemporality `protobuf:"varint,2,opt,name=aggregation_temporality,json=aggregationTemporality,proto3,enum=redpanda.otel.v1.AggregationTemporality" json:"aggregation_temporality,omitempty"`
...
func (x *Sum) Reset() {
	*x = Sum{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Sum) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{2}
}
...
func (x *Histogram) Reset() {
	*x = Histogram{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Histogram) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExponentialHistogram) Reset() {
	*x = ExponentialHistogram{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogram) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{4}
}
...
// and OpenMetrics (see:
// https://github.com/prometheus/OpenMetrics/blob/4dbf6075567ab43296eed941037c12951faafb92/protos/prometheus.proto#L45)
...
func (x *Summary) Reset() {
	*x = Summary{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Summary) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{5}
}
...
func (x *NumberDataPoint) Reset() {
	*x = NumberDataPoint{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NumberDataPoint) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{6}
}
...
type HistogramDataPoint struct {
	...
	// see:
	// https://github.com/prometheus/OpenMetrics/blob/v1.0.0/specification/OpenMetrics.md#histogram
	...
	// is when the length of bucket_counts is 0, then the length of
	// explicit_bounds must also be 0.
...
func (x *HistogramDataPoint) Reset() {
	*x = HistogramDataPoint{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HistogramDataPoint) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{7}
}
...
func (x *ExponentialHistogramDataPoint) Reset() {
	*x = ExponentialHistogramDataPoint{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogramDataPoint) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{8}
}
...
type SummaryDataPoint struct {
	...
	// doing so.  This is specifically to enforce compatibility w/ OpenMetrics,
	// see:
	// https://github.com/prometheus/OpenMetrics/blob/v1.0.0/specification/OpenMetrics.md#summary
...
func (x *SummaryDataPoint) Reset() {
	*x = SummaryDataPoint{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryDataPoint) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{9}
}
...
func (x *Exemplar) Reset() {
	*x = Exemplar{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Exemplar) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{10}
}
...
type ExponentialHistogramDataPoint_Buckets struct {
	...
	// the count of the bucket at index (offset+i). bucket_counts[i] is the
	// count of values greater than base^(offset+i) and less than or equal to
	// base^(offset+i+1).
	//
...
func (x *ExponentialHistogramDataPoint_Buckets) Reset() {
	*x = ExponentialHistogramDataPoint_Buckets{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogramDataPoint_Buckets) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{8, 0}
}
...
func (x *SummaryDataPoint_ValueAtQuantile) Reset() {
	*x = SummaryDataPoint_ValueAtQuantile{}
	mi := &file_redpanda_otel_v1_metric_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryDataPoint_ValueAtQuantile) Descriptor() ([]byte, []int) {
	return file_redpanda_otel_v1_metric_proto_rawDescGZIP(), []int{9, 0}
}
...
var File_redpanda_otel_v1_metric_proto protoreflect.FileDescriptor

const file_redpanda_otel_v1_metric_proto_rawDesc = "" +
	"\n" +
	"\x1dredpanda/otel/v1/metric.proto\x12\x10redpanda.otel.v1\x1a\x1dredpanda/otel/v1/common.proto\"\x91\x05\n" +
	"\x06Metric\x126\n" +
	...
	"\x10scope_schema_url\x18\x04 \x01(\tR\x0escopeSchemaUrl\x12\x12\n" +
	"\x04name\x18\x05 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x06 \x01(\tR\vdescription\x12\x12\n" +
	"\x04unit\x18\a \x01(\tR\x04unit\x12/\n" +
	"\x05gauge\x18\b \x01(\v2\x17.redpanda.otel.v1.GaugeH\x00R\x05gauge\x12)\n" +
	"\x03sum\x18\t \x01(\v2\x15.redpanda.otel.v1.SumH\x00R\x03sum\x12;\n" +
	"\thistogram\x18\n" +
	" \x01(\v2\x1b.redpanda.otel.v1.HistogramH\x00R\thistogram\x12]\n" +
	"\x15exponential_histogram\x18\v \x01(\v2&.redpanda.otel.v1.ExponentialHistogramH\x00R\x14exponentialHistogram\x125\n" +
	"\asummary\x18\f \x01(\v2\x19.redpanda.otel.v1.SummaryH\x00R\asummary\x126\n" +
	"\bmetadata\x18\r \x03(\v2\x1a.redpanda.otel.v1.KeyValueR\bmetadataB\x06\n" +
	"\x04data\"K\n" +
	"\x05Gauge\x12B\n" +
	"\vdata_points\x18\x01 \x03(\v2!.redpanda.otel.v1.NumberDataPointR\n" +
	"dataPoints\"\xcf\x01\n" +
	"\x03Sum\x12B\n" +
	"\vdata_points\x18\x01 \x03(\v2!.redpanda.otel.v1.NumberDataPointR\n" +
	"dataPoints\x12a\n" +
	"\x17aggregation_temporality\x18\x02 \x01(\x0e2(.redpanda.otel.v1.AggregationTemporalityR\x16aggregationTemporality\x12!\n" +
	"\fis_monotonic\x18\x03 \x01(\bR\visMonotonic\"\xb5\x01\n" +
	"\tHistogram\x12E\n" +
	"\vdata_points\x18\x01 \x03(\v2$.redpanda.otel.v1.HistogramDataPointR\n" +
	"dataPoints\x12a\n" +
	"\x17aggregation_temporality\x18\x02 \x01(\x0e2(.redpanda.otel.v1.AggregationTemporalityR\x16aggregationTemporality\"\xcb\x01\n" +
	"\x14ExponentialHistogram\x12P\n" +
	"\vdata_points\x18\x01 \x03(\v2/.redpanda.otel.v1.ExponentialHistogramDataPointR\n" +
	"dataPoints\x12a\n" +
	"\x17aggregation_temporality\x18\x02 \x01(\x0e2(.redpanda.otel.v1.AggregationTemporalityR\x16aggregationTemporality\"N\n" +
	"\aSummary\x12C\n" +
	"\vdata_points\x18\x01 \x03(\v2\".redpanda.otel.v1.SummaryDataPointR\n" +
	"dataPoints\"\xbb\x02\n" +
	"\x0fNumberDataPoint\x12:\n" +
	"\n" +
	"attributes\x18\a \x03(\v2\x1a.redpanda.otel.v1.KeyValueR\n" +
	"attributes\x12/\n" +
	...
	"\x06as_int\x18\x06 \x01(\x10H\x00R\x05asInt\x128\n" +
	"\texemplars\x18\x05 \x03(\v2\x1a.redpanda.otel.v1.ExemplarR\texemplars\x12\x14\n" +
	"\x05flags\x18\b \x01(\rR\x05flagsB\a\n" +
	"\x05valueJ\x04\b\x01\x10\x02\"\xbe\x03\n" +
	"\x12HistogramDataPoint\x12:\n" +
	"\n" +
	"attributes\x18\t \x03(\v2\x1a.redpanda.otel.v1.KeyValueR\n" +
	"attributes\x12/\n" +
	"\x14start_time_unix_nano\x18\x02 \x01(\x06R\x11startTimeUnixNano\x12$\n" +
	...
	"\x0fexplicit_bounds\x18\a \x03(\x01R\x0eexplicitBounds\x128\n" +
	"\texemplars\x18\b \x03(\v2\x1a.redpanda.otel.v1.ExemplarR\texemplars\x12\x14\n" +
	"\x05flags\x18\n" +
	...
	"\x04_sumB\x06\n" +
	"\x04_minB\x06\n" +
	"\x04_maxJ\x04\b\x01\x10\x02\"\xc3\x05\n" +
	...
	"\n" +
	"zero_count\x18\a \x01(\x06R\tzeroCount\x12S\n" +
	"\bpositive\x18\b \x01(\v27.redpanda.otel.v1.ExponentialHistogramDataPoint.BucketsR\bpositive\x12S\n" +
	"\bnegative\x18\t \x01(\v27.redpanda.otel.v1.ExponentialHistogramDataPoint.BucketsR\bnegative\x12\x14\n" +
	"\x05flags\x18\n" +
	" \x01(\rR\x05flags\x128\n" +
	"\texemplars\x18\v \x03(\v2\x1a.redpanda.otel.v1.ExemplarR\texemplars\x12\x15\n" +
	...
	"\x0fquantile_values\x18\x06 \x03(\v22.redpanda.otel.v1.SummaryDataPoint.ValueAtQuantileR\x0equantileValues\x12\x14\n" +
	"\x05flags\x18\b \x01(\rR\x05flags\x1aC\n" +
	"\x0fValueAtQuantile\x12\x1a\n" +
	"\bquantile\x18\x01 \x01(\x01R\bquantile\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05valueJ\x04\b\x01\x10\x02\"\xf8\x01\n" +
	"\bExemplar\x12K\n" +
	"\x13filtered_attributes\x18\a \x03(\v2\x1a.redpanda.otel.v1.KeyValueR\x12filteredAttributes\x12$\n" +
	...
	"'DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK\x10\x01B\xd4\x01\n" +
	"\x14com.redpanda.otel.v1B\vMetricProtoP\x01ZMbuf.build/gen/go/redpandadata/otel/protocolbuffers/go/redpanda/otel/v1;otelv1\xa2\x02\x03ROX\xaa\x02\x10Redpanda.Otel.V1\xca\x02\x10Redpanda\\Otel\\V1\xe2\x02\x1cRedpanda\\Otel\\V1\\GPBMetadata\xea\x02\x12Redpanda::Otel::V1b\x06proto3"

var (
	file_redpanda_otel_v1_metric_proto_rawDescOnce sync.Once
	file_redpanda_otel_v1_metric_proto_rawDescData []byte
)

func file_redpanda_otel_v1_metric_proto_rawDescGZIP() []byte {
	file_redpanda_otel_v1_metric_proto_rawDescOnce.Do(func() {
		file_redpanda_otel_v1_metric_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_redpanda_otel_v1_metric_proto_rawDesc), len(file_redpanda_otel_v1_metric_proto_rawDesc)))
	})
	return file_redpanda_otel_v1_metric_proto_rawDescData
}

var file_redpanda_otel_v1_metric_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_redpanda_otel_v1_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_redpanda_otel_v1_metric_proto_goTypes = []any{
	(AggregationTemporality)(0),                   // 0: redpanda.otel.v1.AggregationTemporality
	(DataPointFlags)(0),                           // 1: redpanda.otel.v1.DataPointFlags
	(*Metric)(nil),                                // 2: redpanda.otel.v1.Metric
	(*Gauge)(nil),                                 // 3: redpanda.otel.v1.Gauge
	(*Sum)(nil),                                   // 4: redpanda.otel.v1.Sum
	(*Histogram)(nil),                             // 5: redpanda.otel.v1.Histogram
	(*ExponentialHistogram)(nil),                  // 6: redpanda.otel.v1.ExponentialHistogram
	(*Summary)(nil),                               // 7: redpanda.otel.v1.Summary
	(*NumberDataPoint)(nil),                       // 8: redpanda.otel.v1.NumberDataPoint
	(*HistogramDataPoint)(nil),                    // 9: redpanda.otel.v1.HistogramDataPoint
	(*ExponentialHistogramDataPoint)(nil),         // 10: redpanda.otel.v1.ExponentialHistogramDataPoint
	(*SummaryDataPoint)(nil),                      // 11: redpanda.otel.v1.SummaryDataPoint
	(*Exemplar)(nil),                              // 12: redpanda.otel.v1.Exemplar
	(*ExponentialHistogramDataPoint_Buckets)(nil), // 13: redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets
	(*SummaryDataPoint_ValueAtQuantile)(nil),      // 14: redpanda.otel.v1.SummaryDataPoint.ValueAtQuantile
	(*Resource)(nil),                              // 15: redpanda.otel.v1.Resource
	(*InstrumentationScope)(nil),                  // 16: redpanda.otel.v1.InstrumentationScope
	(*KeyValue)(nil),                              // 17: redpanda.otel.v1.KeyValue
}
var file_redpanda_otel_v1_metric_proto_depIdxs = []int32{
	15, // 0: redpanda.otel.v1.Metric.resource:type_name -> redpanda.otel.v1.Resource
	16, // 1: redpanda.otel.v1.Metric.scope:type_name -> redpanda.otel.v1.InstrumentationScope
	3,  // 2: redpanda.otel.v1.Metric.gauge:type_name -> redpanda.otel.v1.Gauge
	4,  // 3: redpanda.otel.v1.Metric.sum:type_name -> redpanda.otel.v1.Sum
	5,  // 4: redpanda.otel.v1.Metric.histogram:type_name -> redpanda.otel.v1.Histogram
	6,  // 5: redpanda.otel.v1.Metric.exponential_histogram:type_name -> redpanda.otel.v1.ExponentialHistogram
	7,  // 6: redpanda.otel.v1.Metric.summary:type_name -> redpanda.otel.v1.Summary
	17, // 7: redpanda.otel.v1.Metric.metadata:type_name -> redpanda.otel.v1.KeyValue
	8,  // 8: redpanda.otel.v1.Gauge.data_points:type_name -> redpanda.otel.v1.NumberDataPoint
	8,  // 9: redpanda.otel.v1.Sum.data_points:type_name -> redpanda.otel.v1.NumberDataPoint
	0,  // 10: redpanda.otel.v1.Sum.aggregation_temporality:type_name -> redpanda.otel.v1.AggregationTemporality
	9,  // 11: redpanda.otel.v1.Histogram.data_points:type_name -> redpanda.otel.v1.HistogramDataPoint
	0,  // 12: redpanda.otel.v1.Histogram.aggregation_temporality:type_name -> redpanda.otel.v1.AggregationTemporality
	10, // 13: redpanda.otel.v1.ExponentialHistogram.data_points:type_name -> redpanda.otel.v1.ExponentialHistogramDataPoint
	0,  // 14: redpanda.otel.v1.ExponentialHistogram.aggregation_temporality:type_name -> redpanda.otel.v1.AggregationTemporality
	11, // 15: redpanda.otel.v1.Summary.data_points:type_name -> redpanda.otel.v1.SummaryDataPoint
	17, // 16: redpanda.otel.v1.NumberDataPoint.attributes:type_name -> redpanda.otel.v1.KeyValue
	12, // 17: redpanda.otel.v1.NumberDataPoint.exemplars:type_name -> redpanda.otel.v1.Exemplar
	17, // 18: redpanda.otel.v1.HistogramDataPoint.attributes:type_name -> redpanda.otel.v1.KeyValue
	12, // 19: redpanda.otel.v1.HistogramDataPoint.exemplars:type_name -> redpanda.otel.v1.Exemplar
	17, // 20: redpanda.otel.v1.ExponentialHistogramDataPoint.attributes:type_name -> redpanda.otel.v1.KeyValue
	13, // 21: redpanda.otel.v1.ExponentialHistogramDataPoint.positive:type_name -> redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets
	13, // 22: redpanda.otel.v1.ExponentialHistogramDataPoint.negative:type_name -> redpanda.otel.v1.ExponentialHistogramDataPoint.Buckets
	12, // 23: redpanda.otel.v1.ExponentialHistogramDataPoint.exemplars:type_name -> redpanda.otel.v1.Exemplar
	17, // 24: redpanda.otel.v1.SummaryDataPoint.attributes:type_name -> redpanda.otel.v1.KeyValue
	14, // 25: redpanda.otel.v1.SummaryDataPoint.quantile_values:type_name -> redpanda.otel.v1.SummaryDataPoint.ValueAtQuantile
	17, // 26: redpanda.otel.v1.Exemplar.filtered_attributes:type_name -> redpanda.otel.v1.KeyValue
...
func init() { file_redpanda_otel_v1_metric_proto_init() }
func file_redpanda_otel_v1_metric_proto_init() {
	if File_redpanda_otel_v1_metric_proto != nil {
		return
	}
	file_redpanda_otel_v1_common_proto_init()
	file_redpanda_otel_v1_metric_proto_msgTypes[0].OneofWrappers = []any{
		(*Metric_Gauge)(nil),
		(*Metric_Sum)(nil),
	...
	file_redpanda_otel_v1_metric_proto_msgTypes[6].OneofWrappers = []any{
		(*NumberDataPoint_AsDouble)(nil),
		(*NumberDataPoint_AsInt)(nil),
	}
	file_redpanda_otel_v1_metric_proto_msgTypes[7].OneofWrappers = []any{}
	file_redpanda_otel_v1_metric_proto_msgTypes[8].OneofWrappers = []any{}
	file_redpanda_otel_v1_metric_proto_msgTypes[10].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_redpanda_otel_v1_metric_proto_rawDesc), len(file_redpanda_otel_v1_metric_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_redpanda_otel_v1_metric_proto_goTypes,
		DependencyIndexes: file_redpanda_otel_v1_metric_proto_depIdxs,
		EnumInfos:         file_redpanda_otel_v1_metric_proto_enumTypes,
		MessageInfos:      file_redpanda_otel_v1_metric_proto_msgTypes,
	}.Build()
	File_redpanda_otel_v1_metric_proto = out.File
	file_redpanda_otel_v1_metric_proto_goTypes = nil
	file_redpanda_otel_v1_metric_proto_depIdxs = nil
}
