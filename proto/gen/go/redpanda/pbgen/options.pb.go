...
const file_redpanda_pbgen_options_proto_rawDesc = "" +
	"\n" +
	"\x1credpanda/pbgen/options.proto\x12\x0eredpanda.pbgen\x1a google/protobuf/descriptor.proto:C\n" +
...
func file_redpanda_pbgen_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_redpanda_pbgen_options_proto_rawDesc), len(file_redpanda_pbgen_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 3,
			NumServices:   0,
