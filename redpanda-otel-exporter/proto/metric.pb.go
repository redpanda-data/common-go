...
func (*ExponentialHistogramDataPoint_Buckets) Descriptor() ([]byte, []int) {
	return file_metric_proto_rawDescGZIP(), []int{8, 0}
}
...
func (*SummaryDataPoint_ValueAtQuantile) Descriptor() ([]byte, []int) {
	return file_metric_proto_rawDescGZIP(), []int{9, 0}
}
...
const file_metric_proto_rawDesc = "" +
	"\n" +
	"\fmetric.proto\x12\x10redpanda.otel.v1\x1a\fcommon.proto\"\x91\x05\n" +
	"\x06Metric\x126\n" +
	...
	"'DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK\x10\x01BAZ?github.com/redpanda-data/common-go/redpanda-otel-exporter/protob\x06proto3"
...
var file_metric_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
func file_metric_proto_init() {
	...
	file_metric_proto_msgTypes[6].OneofWrappers = []any{
		(*NumberDataPoint_AsDouble)(nil),
		(*NumberDataPoint_AsInt)(nil),
	}
	file_metric_proto_msgTypes[7].OneofWrappers = []any{}
	file_metric_proto_msgTypes[8].OneofWrappers = []any{}
	file_metric_proto_msgTypes[10].OneofWrappers = []any{
