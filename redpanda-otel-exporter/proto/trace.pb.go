...
func (Status_StatusCode) EnumDescriptor() ([]byte, []int) {
	return file_trace_proto_rawDescGZIP(), []int{1, 0}
}
...
const file_trace_proto_rawDesc = "" +
	"\n" +
	"\vtrace.proto\x12\x10redpanda.otel.v1\x1a\fcommon.proto\"\xc1\v\n" +
	"\x04Span\x126\n" +
	...
	"!SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK\x10\x80\x04BAZ?github.com/redpanda-data/common-go/redpanda-otel-exporter/protob\x06proto3"
