...
const file_log_proto_rawDesc = "" +
	"\n" +
	"\tlog.proto\x12\x10redpanda.otel.v1\x1a\fcommon.proto\"\xb7\x05\n" +
	"\tLogRecord\x126\n" +
	...
	"!LOG_RECORD_FLAGS_TRACE_FLAGS_MASK\x10\xff\x01BAZ?github.com/redpanda-data/common-go/redpanda-otel-exporter/protob\x06proto3"
