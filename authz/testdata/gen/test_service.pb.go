...
const file_test_service_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\xc9\x04\n" +
	"\vTestService\x12a\n" +
	...
	"\awidgets\x12\x11request.widget.id\x1a\x10test_scoped_perm\x12R\n" +
	"\x11UnannotatedMethod\x12\x1c.authz.test.v1.SimpleRequest\x1a\x1d.authz.test.v1.SimpleResponse\"\x00BLZJgithub.com/redpanda-data/common-go/authz/testdata/gen/authz/test/v1;testv1b\x06proto3"
...
var file_test_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_test_service_proto_goTypes = []any{
	...
	(*GetWidgetRequest)(nil),     // 2: authz.test.v1.GetWidgetRequest
	(*GetWidgetResponse)(nil),    // 3: authz.test.v1.GetWidgetResponse
	(*CreateWidgetRequest)(nil),  // 4: authz.test.v1.CreateWidgetRequest
	(*CreateWidgetResponse)(nil), // 5: authz.test.v1.CreateWidgetResponse
	(*UpdateWidgetRequest)(nil),  // 6: authz.test.v1.UpdateWidgetRequest
	(*UpdateWidgetResponse)(nil), // 7: authz.test.v1.UpdateWidgetResponse
	(*Widget)(nil),               // 8: authz.test.v1.Widget
}
var file_test_service_proto_depIdxs = []int32{
	8, // 0: authz.test.v1.UpdateWidgetRequest.widget:type_name -> authz.test.v1.Widget
	0, // 1: authz.test.v1.TestService.SimpleMethod:input_type -> authz.test.v1.SimpleRequest
	2, // 2: authz.test.v1.TestService.GetWidget:input_type -> authz.test.v1.GetWidgetRequest
	4, // 3: authz.test.v1.TestService.CreateWidget:input_type -> authz.test.v1.CreateWidgetRequest
	6, // 4: authz.test.v1.TestService.UpdateWidget:input_type -> authz.test.v1.UpdateWidgetRequest
	0, // 5: authz.test.v1.TestService.UnannotatedMethod:input_type -> authz.test.v1.SimpleRequest
	1, // 6: authz.test.v1.TestService.SimpleMethod:output_type -> authz.test.v1.SimpleResponse
	3, // 7: authz.test.v1.TestService.GetWidget:output_type -> authz.test.v1.GetWidgetResponse
	5, // 8: authz.test.v1.TestService.CreateWidget:output_type -> authz.test.v1.CreateWidgetResponse
	7, // 9: authz.test.v1.TestService.UpdateWidget:output_type -> authz.test.v1.UpdateWidgetResponse
	1, // 10: authz.test.v1.TestService.UnannotatedMethod:output_type -> authz.test.v1.SimpleResponse
