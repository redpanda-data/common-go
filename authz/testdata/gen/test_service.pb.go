...
const file_test_service_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\xdc\x05\n" +
	"\vTestService\x12a\n" +
...
var file_test_service_proto_depIdxs = []int32{
	...
	0,  // 7: authz.test.v1.TestService.UnannotatedMethod:input_type -> authz.test.v1.SimpleRequest
	1,  // 8: authz.test.v1.TestService.SimpleMethod:output_type -> authz.test.v1.SimpleResponse
	5,  // 9: authz.test.v1.TestService.GetWidget:output_type -> authz.test.v1.GetWidgetResponse
	7,  // 10: authz.test.v1.TestService.CreateWidget:output_type -> authz.test.v1.CreateWidgetResponse
	9,  // 11: authz.test.v1.TestService.UpdateWidget:output_type -> authz.test.v1.UpdateWidgetResponse
	3,  // 12: authz.test.v1.TestService.ListWidgets:output_type -> authz.test.v1.ListWidgetsResponse
	1,  // 13: authz.test.v1.TestService.UnannotatedMethod:output_type -> authz.test.v1.SimpleResponse
